...
| ghostwriter | `.claude/skills/ghostwriter/` | SEO + GEO optimization, persuasive copywriting. Comandi: `/ghostwriter write`, `/ghostwriter audit`, `/ghostwriter research`, `/ghostwriter optimize`, `/ghostwriter schema`, `/ghostwriter persona`, `/ghostwriter pillar-cluster`, `/ghostwriter meta`, `/ghostwriter llms-txt`, `/ghostwriter robots`. 46 regole validazione |
| orson | `.claude/skills/orson/` | Video production. Comandi: `/orson create`, `/orson render`, `/orson formats`, `/orson entrances`. 132 animazioni, 13 director recipes, 4 modi (safe/chaos/hybrid/cocomelon). Integrazione seurat + ghostwriter + audiosculpt |
| audiosculpt | `.claude/skills/audiosculpt/` | Audio production (soundtrack + SFX). Comandi: `/audiosculpt create`, `/audiosculpt add-to-video`, `/audiosculpt preview`, `/audiosculpt styles`. 20 stili, 6 template parametrici, TTS narration, integrazione orson |
